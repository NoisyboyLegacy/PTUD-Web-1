...
<div class="container">
    <div class="row justify-content-center">
        <div class="col-md-6">
            <form action="xulyhinhtron.php" method="GET">
                ...
                <div class="form-group">
                    ...
                    <input class="form-control" type="number" name="dientich" id="" value="<?php echo $dientich; ?>" disabled>
                </div>
                <div class="form-group">
