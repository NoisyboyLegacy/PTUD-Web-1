...
<body>
    <div class="container">
        ...
        <p>Danh sách các nhân viên hiện có |<button class="btn btn-primary"><a href="thucthi.php?banghienthi=emp&action=add" class="badge badge-primary">Thêm</a></button></p>
